...
public class OutputFunc
{
 ...
 public ArrayList<MessageClass> extractMessage() throws JsonParseException, JsonMappingException, IOException
 {
  ...
  messages = objectMapper1.readValue(new File("D://jayesh/message_data.json"), new TypeReference<ArrayList<MessageClass>>(){});  
 ...
 public ArrayList<Comment> showComments() throws JsonParseException, JsonMappingException, IOException
 {
 ...
 public ArrayList<Likes> displayLikes() throws JsonParseException, JsonMappingException, IOException
 {
  ...
  ArrayList<MessageClass> messages = null;
  messages = objectMapper.readValue(new File("D://jayesh/message_data.json"), new TypeReference<ArrayList<MessageClass>>(){});
  //return messages;
 ...
 public MessageClass fetchValues()
 {
 ...
 public void putMessage() throws JSONException, IOException
 {
  ...
  m=fetchValues();
  ObjectMapper objectMapper = new ObjectMapper();
  messageStore = objectMapper.readValue(new File("D://jayesh/message_data.json"), new TypeReference<ArrayList<MessageClass>>(){});
  messageStore.add(m);
  ObjectMapper mapper = new ObjectMapper();
  mapper.writeValue(new File("D://jayesh/message_data.json"),messageStore);
 ...
 public void likeToMessage() throws JSONException, IOException
 {
  System.out.println("Enter the message id:");
  Scanner scan = new Scanner(System.in);
  int message_id = scan.nextInt();
