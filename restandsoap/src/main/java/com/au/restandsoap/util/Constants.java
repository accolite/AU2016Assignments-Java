package com.au.restandsoap.util;
...
public class Constants {
	...
	public static final String DB_URL = "jdbc:sqlserver://localhost:1433;"+"DataBaseName=Messenger;";
	public static String username="sa";
	public static String password="accolite";
