...
public class Constants {
	...
	public static final String DB_URLD1 = "jdbc:sqlserver://localhost:1433;"+"DataBaseName=Datab1";
	public static final String DB_URLD2 = "jdbc:sqlserver://localhost:1433;"+"DataBaseName=Datab2";
