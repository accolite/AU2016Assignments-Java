...
public class Register extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userslist.containsKey(user)){
			...
			response.getWriter().write("The username is already registered. Please <a href=\"/WebChat/\">try</a> again");
		}
		else{
			...
			response.setContentType("text/html");
			response.getWriter().write("Successfully registered. Please <a href=\"/WebChat/index.html\">login</a> now");
		}
	}
