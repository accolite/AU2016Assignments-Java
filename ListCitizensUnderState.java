...
public class ListCitizensUnderState 
{
	static Connection conn = null;
	static Statement stmt = null;
	void list() throws SQLException
	{
		String sql =  "SELECT c.first , c.last " +  "FROM Country_Citizens.dbo.Citizen c " + "INNER JOIN COUNTRY.dbo.District d ON d.Did = c.Did " + "INNER JOIN COUNTRY.dbo.State s ON s.Sid = d.Sid " + "where s.Name ='Delhi' " ;
