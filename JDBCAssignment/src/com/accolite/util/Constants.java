...
public class Constants {
	...
	public static final String DB_URL1 = "jdbc:sqlserver://localhost:1433;"+"DataBaseName=db1;";
	public static final String DB_URL2 = "jdbc:sqlserver://localhost:1433;"+"DataBaseName=db2;";
