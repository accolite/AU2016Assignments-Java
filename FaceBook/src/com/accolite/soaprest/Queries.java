...
public class Queries {
	...
	@Path("addMessage")
	public void addMessage(Message new_msg)
	{
		
		System.out.println(new_msg.getLikes().size());
...
//		    }
	...
	//@Produces(MediaType.APPLICATION_JSON)
	@Path("addLike")
	public void addLike(Like new_like)
	{
	...
	public MessageList viewComments(String mes) {
	...
	public MessageList viewLikes(String mes) {
