 ...
 */
@WebServlet(description = "Broadcaasts message", urlPatterns = { "/Message" })
public class Message extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("message").equals("") || request.getAttribute("messageFilter").equals("") || request.getParameter("message") == null || request.getAttribute("messageFilter") == null)
		{
		...
		if(getServletConfig().getServletContext().getAttribute("messages") == null)
		{
			String user=(String) request.getSession().getAttribute("username");
			 ...
			 messages=user+":"+request.getAttribute("messageFilter")+"\n";
		...
		else
		{
		    ...
		    // messages=	messages.concat(user+":"+request.getParameter("message")+"\n");
		     messages=	messages.concat(user+":"+request.getAttribute("messageFilter")+"\n");
			getServletConfig().getServletContext().setAttribute("messages", messages);
		}
