...
public class ParticipantDAOImpl implements ParticipantDAO {
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#insertParticipant(com.acc.model.ParticipantDetails)
	 */
	public Integer insertParticipant(ParticipantDetails participantDetails){
		...
		if(present==null){
		/*
		 * Insert only when not available
		 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#insertOrganizer(java.lang.String, java.lang.String)
	 */
	public int insertOrganizer(String event_id, String emailId){
		...
		/*
		 * See if already added, else don't add again
		 */
		...
		if(present==null){
			/*
			 * Insert only when not already available
			 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#removeParticipant(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#removeOrganizer(java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#getAllParticipants(int)
	 */
	public List<ParticipantDetails> getAllParticipants(int eventId){
		...
		for(int i=0;i<participants.size();i++){
			...
			/*
			 * Get group details of each participant
			 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#addPoints(java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#getGroups(int)
	 */
	public List<Group> getGroups(int eventId){
		String query = "select * from groups where event_id="+eventId+" order by points DESC;";
	...
	/* (non-Javadoc)
	 * @see com.acc.dao.ParticipantDAO#isOrganizer(java.lang.String, java.lang.Integer)
	 */
	public boolean isOrganizer(String email, Integer event_id) {
		/*
		 * See if a valid user
		 */
		String query = "SELECT _id from users where email_id='"+email+"';";
		Integer user_id = jdbc.query(query, new ResultSetExtractor<Integer>() {
		...
		/*
		 * If available, then see if an organizer
		 */
		query = "select user_id from roles_users where role_id=1 and event_id="+event_id+" and user_id="+user_id+";";
		Integer available = jdbc.query(query, new ResultSetExtractor<Integer>() {
