...
public class AddNewEmployeeEntity extends HttpServlet {
		 ...
		 env.put(Context.INITIAL_CONTEXT_FACTORY,"org.apache.naming.java.javaURLContextFactory");
			try
			{
				Context initialContext=new InitialContext();
				 ...
				 PreparedStatement pstmt = connection.prepareStatement("Use Company "+ "INSERT INTO dbo.Employee values(?,?,?,?)");
				    ...
				    System.out.println("Succesfully inserted"); 
				      Session session = null;
				       Context initCtx = new InitialContext();
				         ...
				         message.setFrom(new InternetAddress("shremanishu@gmail.com"));
