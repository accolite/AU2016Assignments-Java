 ...
 */
@WebServlet(description = "Shows the list of employees and gives an option to add new employee", urlPatterns = {
		"/Manager" })
public class Manager extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement preparedStatement = connection.prepareStatement("use EmployeeDB select * from employee");
